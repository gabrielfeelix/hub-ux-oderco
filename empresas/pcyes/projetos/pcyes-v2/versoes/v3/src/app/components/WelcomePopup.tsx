                ...
                {!submitted ? (
                  <>
                    <h3
                      ...
                      style={{ fontFamily: "var(--font-family-figtree)", fontSize: "32px", fontWeight: 700, lineHeight: 1.08, letterSpacing: "-0.02em" }}
                    >
                      Cadastre-se e ganhe <span className="text-primary">10% OFF</span><br />na primeira compra
                    </h3>
                    <p
                      className="text-foreground/55 mb-7"
                      style={{ fontFamily: "var(--font-family-inter)", fontSize: "14px", lineHeight: 1.6 }}
                    >
                  ...
                  <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="text-center">
                    ...
                    <h3
                      className="text-foreground mb-3"
                      style={{ fontFamily: "var(--font-family-figtree)", fontSize: "26px", fontWeight: 700, lineHeight: 1.1 }}
                    >
                      Cadastro realizado!
                    </h3>
                    <p
