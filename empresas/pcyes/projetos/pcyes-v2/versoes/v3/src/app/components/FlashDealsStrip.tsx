      ...
      <Link to={`/produto/${product.id}`} className="block">
        ...
        >
          ...
          <CTAButton
            ...
            className="absolute bottom-4 left-1/2 z-20 -translate-x-1/2 translate-y-0 md:translate-y-2 opacity-100 md:opacity-0 transition-all duration-300 group-hover:translate-y-0 md:group-hover:opacity-100 cursor-pointer shadow-[var(--shadow-buy-cta-sm)]"
          >
