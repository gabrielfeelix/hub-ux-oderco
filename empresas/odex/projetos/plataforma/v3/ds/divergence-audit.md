...
> v0.25 · 2026-05-20 · Auto-atualizado a cada feature extraction (C.10+) e atom creation (H.1+)
...
- v0.25 · 2026-05-20 · **PHASE H ATOMS COMPLETE · 20/20 atoms criados.** Final batch: H.18 `.ds-modal` (3 DUPES) · H.19 `.ds-form-grid` (4 DUPES) · H.20 `.ds-tab-pill` (2 DUPES · adicionado em tabs.css). Audit dizia 23 atoms · 3 foram absorvidos como variants (.ds-btn-on-brand em buttons · .ds-tab-pill em tabs · .ds-dot-sep em status-dot · .ds-icon-btn-badge em icon-btn). Next: H.21+ markup migration (substituir uses por DS classes em features).
- v0.24 · 2026-05-20 · **H.11-H.17 batch · 7 atoms criados.** stepper-input (3x · pdp-qty/qty-stepper/cart-qty) · tabs (4x · pdp-tabs/admin-tabs/dash-products-tabs/notif-drawer-tabs) · kv-list (3x · pdp-meta-grid/pdp-price-breakdown/ped-resumo-kv) · btn-on-brand (3x · variants em buttons.css) · link-back (5x · orc/ped/pv/client/auth back) · card-selectable (3x · mk-kit-card/nc-tipo-opt/ov-radio) · alert (4x · orc/mk-tax/ckform/admin alerts). Total 17/23 atoms done · 6 restantes (H.18 modal, H.19 form-grid, H.20 tab-pill + markup migration).
