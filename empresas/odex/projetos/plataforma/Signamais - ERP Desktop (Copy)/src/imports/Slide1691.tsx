import svgPaths from "./svg-v1vp7r3bwp";
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="paid">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="paid">
          <mask height="24" id="mask0_1_1536" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
...
function CheckCircle() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="check_circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="check_circle">
          <mask height="24" id="mask0_1_1478" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
...
function Send() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="send">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="send">
          <mask height="24" id="mask0_1_1532" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
...
function ShareEta() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="share_eta">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="share_eta">
          <mask height="24" id="mask0_1_1520" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
...
function EmergencyHome() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="emergency_home">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="emergency_home">
          <mask height="24" id="mask0_1_1506" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
...
function Close() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="close">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g>
          <mask height="24" id="mask0_1_1502" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
...
function Add() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="add">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="add">
          <mask height="24" id="mask0_1_1494" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
...
function Search() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="search">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="search">
          <mask height="24" id="mask0_1_1528" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
...
function FilterAlt() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="filter_alt">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="filter_alt">
          <mask height="24" id="mask0_1_1490" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
...
function Add1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="add">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="add">
          <mask height="24" id="mask0_1_1474" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="send">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="send">
          <mask height="16" id="mask0_1_1498" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
...
function ActionHome() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="action home">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="more_vert">
          <mask height="24" id="mask0_1_1470" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
...
function CheckCircle1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="check_circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="check_circle">
          <mask height="16" id="mask0_1_1466" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
...
function ShareEta1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="share_eta">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="share_eta">
          <mask height="16" id="mask0_1_1454" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
...
function Close1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="close">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g>
          <mask height="16" id="mask0_1_1450" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
...
function EmergencyHome1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="emergency_home">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="emergency_home">
          <mask height="16" id="mask0_1_1482" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[32px] isolate items-start left-[360px] top-[50px] w-[1536px]">
      <Frame61 />
      <Frame59 />
    </div>
  );
...
function Roxo() {
  return (
    <div className="h-[39px] relative shrink-0 w-[141px]" data-name="roxo">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 141 39">
        <g clipPath="url(#clip0_1_1437)" id="roxo">
          <path d={svgPaths.p21980c70} fill="var(--fill-0, #252529)" id="Vector" />
          <path d={svgPaths.p1bee1d00} fill="var(--fill-0, #252529)" id="Vector_2" />
          <g id="Group">
            <path d={svgPaths.p1c2aa300} fill="var(--fill-0, #3B1458)" id="Vector_3" />
            <path d={svgPaths.p4963c00} fill="var(--fill-0, #3B1458)" id="Vector_4" />
          </g>
          <g id="Group_2">
            <path d={svgPaths.pa5df680} fill="var(--fill-0, #3B1458)" id="Vector_5" />
            <path d={svgPaths.p2435c700} fill="var(--fill-0, #3B1458)" id="Vector_6" />
            <path d={svgPaths.pdf213b0} fill="var(--fill-0, #3B1458)" id="Vector_7" />
            <path d={svgPaths.p2714db80} fill="var(--fill-0, #3B1458)" id="Vector_8" />
          </g>
          <path d={svgPaths.pcbd5e00} fill="var(--fill-0, #3B1458)" id="Vector_9" />
        </g>
        <defs>
          <clipPath id="clip0_1_1437">
            <rect fill="white" height="39" width="141" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function Contract() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="contract">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="contract">
          <mask height="24" id="mask0_1_1458" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
...
function Frame69() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <Contract />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#531788] text-[16px]">Documentos</p>
    </div>
  );
}
...
function MenuButton() {
  return (
    <div className="bg-[#f5eafe] relative rounded-[16px] shadow-[0px_0px_36px_0px_rgba(225,227,235,0.4)] shrink-0 w-full" data-name="menu button">
      <div className="flex flex-row items-center size-full">
...
function Contract1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="contract">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="contract">
          <mask height="24" id="mask0_1_1510" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
...
function Frame70() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <Contract1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#34393e] text-[16px]">Gestão de Clientes</p>
    </div>
  );
}
...
function Frame72() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#34393e] text-[16px]">Maicol Géquisom</p>
    </div>
  );
}
...
function Settings() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="settings">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="settings">
          <mask height="24" id="mask0_1_1462" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
...
function Profile() {
  return (
    <div className="relative rounded-[16px] shrink-0 w-full" data-name="profile">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[18px] items-center p-[8px] relative w-full">
          <Frame72 />
          <Settings />
        </div>
      </div>
...
function ArrowBack() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="arrow_back">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="arrow_back">
          <mask height="24" id="mask0_1_1431" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_1_1431)">
            <path d={svgPaths.p3166edc0} fill="var(--fill-0, #34393E)" id="arrow_back_2" />
          </g>
        </g>
      </svg>
    </div>
...
function SideBar() {
  return (
    <div className="absolute bg-white h-[1080px] left-0 top-0 w-[336px]" data-name="side bar">
      <div className="content-stretch flex flex-col items-start justify-between overflow-clip px-[24px] py-[50px] relative rounded-[inherit] size-full">
        <Roxo />
        <Frame68 />
        <Frame71 />
      </div>
...
export default function Slide() {
  return (
    <div className="bg-white relative size-full" data-name="Slide 16:9 - 1">
      <Frame3 />
      <SideBar />
    </div>
  );
