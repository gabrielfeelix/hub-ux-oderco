import svgPaths from "./svg-5p23s4xbky";
...
function Frame2() {
  return (
    <div className="content-stretch flex items-start relative shrink-0">
      <p className="font-['Lufga:Bold',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#177b4c] text-[16px]">10 créditos foram adicionados com sucesso!</p>
    </div>
  );
}
